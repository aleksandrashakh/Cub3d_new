...
SOURCE 		= src/main.c src/get_next_line.c src/get_next_line_utils.c \
			src/init/init.c src/init/parse_map_file.c src/init/parse_map_properties.c src/init/init_sprite.c \
			...
			src/hooks/keyhooks.c src/hooks/mousehooks.c src/hooks/open_door.c \
			src/move/move.c src/move/translate.c\
			src/render/draw.c src/render/raycast.c src/render/render_pov.c src/render/render_scene.c \
			src/render/render_minimap.c src/render/render_sprites.c \
			src/exit/exit.c src/exit/free.c src/exit/free1.c src/exit/mlx_destroy.c \
